...
!         write(*,*)i,mype,rand_driv(i),randA(i),randP(i),randphase(i) 
  ...
  ! corresponding normalization values (default value 1)
    ...
    double precision:: gradp(ixGlo1:ixGhi1,ixGlo2:ixGhi2),dp(ixGlo1:ixGhi1,&
       ixGlo2:ixGhi2), ggrid(ixImin1:ixImax1,ixImin2:ixImax2)
  ...
  ! putting the schlierplot of density in nwauxio=1
     w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,nw+2)=dexp(-kk*(gradrho(ixOmin1:ixOmax1,&
        ixOmin2:ixOmax2)-kk0*grhomax)/(kk1*grhomax-kk0*grhomax))

   
    w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,nw+&
       3)=unit_velocity*dsqrt(hd_gamma*pth(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2)/w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,rho_))
     ...
     do idims=1,ndim
       select case(typegrad)
       case("central")
         call gradient(pth(ixOmin1:ixOmax1,ixOmin2:ixOmax2),ixImin1,ixImin2,&
            ixImax1,ixImax2,ixOmin1,ixOmin2,ixOmax1,ixOmax2,idims,dp)
       case("limited")
         call gradientS(pth(ixOmin1:ixOmax1,ixOmin2:ixOmax2),ixImin1,ixImin2,&
            ixImax1,ixImax2,ixOmin1,ixOmin2,ixOmax1,ixOmax2,idims,dp)
       end select
       gradp(ixOmin1:ixOmax1,ixOmin2:ixOmax2)=pth(ixOmin1:ixOmax1,&
   ...
   call getggrav(ggrid,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,ixOmax1,&
      ixOmax2,x)
   w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,nw+4)=gradp(ixOmin1:ixOmax1,&
      ixOmin2:ixOmax2)-w(ixImin1:ixImax1,ixImin2:ixImax2,&
